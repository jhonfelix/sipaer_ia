      ...
      subsections: [
        {
          ...
          order: 1,
          content: `<table class="sipaer-table"><tbody><tr><th class="sipaer-header" colspan="4">DADOS DA OCORRÊNCIA</th></tr><tr><td class="sipaer-label">DATA - HORA</td><td class="sipaer-value">14JUN2025 — 15:16 (UTC)</td><td class="sipaer-label">INVESTIGAÇÃO</td><td class="sipaer-value">SERIPA II</td></tr><tr><td class="sipaer-label">SUMA Nº</td><td class="sipaer-value">A-092/CENIPA/2025</td><td class="sipaer-label">CLASSIFICAÇÃO</td><td class="sipaer-value">ACIDENTE</td></tr><tr><td class="sipaer-label">TIPO(S)</td><td class="sipaer-value" colspan="3">[LOC-G] PERDA DE CONTROLE NO SOLO  •  [RE] EXCURSÃO DE PISTA</td></tr><tr><td class="sipaer-label">AERÓDROMO</td><td class="sipaer-value">FAZENDA CANAÃ (SD7E)</td><td class="sipaer-label">MUNICÍPIO/UF</td><td class="sipaer-value">TERESINA/PI</td></tr><tr><td class="sipaer-label">COORDENADAS</td><td class="sipaer-value" colspan="3">04°57'34"S  042°47'35"W</td></tr></tbody></table><table class="sipaer-table"><tbody><tr><th class="sipaer-header" colspan="6">DADOS DA AERONAVE</th></tr><tr><td class="sipaer-label">MATRÍCULA</td><td class="sipaer-value">PP-AFK</td><td class="sipaer-label">FABRICANTE</td><td class="sipaer-value">CESSNA</td><td class="sipaer-label">MODELO</td><td class="sipaer-value">172M</td></tr><tr><td class="sipaer-label">OPERADOR</td><td class="sipaer-value" colspan="3">Particular</td><td class="sipaer-label">OPERAÇÃO</td><td class="sipaer-value"> </td></tr><tr><td class="sipaer-label">DANOS À AERONAVE</td><td class="sipaer-value" colspan="5">SUBSTANCIAL</td></tr></tbody></table><table class="sipaer-table"><tbody><tr><th class="sipaer-header" colspan="9">PESSOAS A BORDO / LESÕES / DANOS</th></tr><tr><th class="sipaer-col-header"> </th><th class="sipaer-col-header">Nº</th><th class="sipaer-col-header">Ileso</th><th class="sipaer-col-header">Leve</th><th class="sipaer-col-header">Grave</th><th class="sipaer-col-header">Fatal</th><th class="sipaer-col-header">Desconhecido</th><th class="sipaer-col-header">Danos Materiais</th><th class="sipaer-col-header">Danos ao M. Ambiente</th></tr><tr><td class="sipaer-label">Tripulantes</td><td class="sipaer-value">1</td><td class="sipaer-value"> </td><td class="sipaer-value">1</td><td class="sipaer-value"> </td><td class="sipaer-value"> </td><td class="sipaer-value"> </td><td class="sipaer-value"> </td><td class="sipaer-value"> </td></tr><tr><td class="sipaer-label">Passageiros</td><td class="sipaer-value">2</td><td class="sipaer-value">1</td><td class="sipaer-value">1</td><td class="sipaer-value"> </td><td class="sipaer-value"> </td><td class="sipaer-value"> </td><td class="sipaer-value"> </td><td class="sipaer-value"> </td></tr><tr><td class="sipaer-label">Terceiros</td><td class="sipaer-value">0</td><td class="sipaer-value"> </td><td class="sipaer-value"> </td><td class="sipaer-value"> </td><td class="sipaer-value"> </td><td class="sipaer-value"> </td><td class="sipaer-value"> </td><td class="sipaer-value"> </td></tr><tr><td class="sipaer-label sipaer-total">Total</td><td class="sipaer-value sipaer-total">3</td><td class="sipaer-value sipaer-total">1</td><td class="sipaer-value sipaer-total">2</td><td class="sipaer-value sipaer-total"> </td><td class="sipaer-value sipaer-total"> </td><td class="sipaer-value sipaer-total"> </td><td class="sipaer-value sipaer-total">Substancial</td><td class="sipaer-value sipaer-total"> </td></tr></tbody></table>`,
          isCompleted: true,
        },
      ],
    },
