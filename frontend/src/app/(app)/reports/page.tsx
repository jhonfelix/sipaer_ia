...
function ProgressBar({ progress }: { progress: Report["progress"] }) {
  ...
  return (
    <div className="flex items-center gap-2 min-w-[90px]">
      ...
      <span className="text-xs text-white/35 tabular-nums w-8 text-right">
        {pct}%
      </span>
    </div>
  );
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 gap-5">
      ...
      <div className="text-center space-y-1">
        <p className="text-white/60 font-medium">Nenhum relatório encontrado</p>
      ...
      <div className="max-w-5xl mx-auto p-6 space-y-6">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white/[0.04] border border-white/[0.08] text-white placeholder-white/20 text-sm focus:outline-none focus:border-blue-500/40 focus:bg-white/[0.07] transition-all"
          />
        </div>
        ...
        {loading ? (
          ...
          <div className="rounded-2xl border border-white/[0.08] overflow-hidden">
            {/* Table head */}
            <div className="grid grid-cols-[1fr_140px_120px_140px_44px] gap-x-4 px-5 py-3 border-b border-white/[0.06] bg-white/[0.02]">
            ...
            <ul className="divide-y divide-white/[0.04]">
              {filtered.map((report) => (
                <li key={report.id}>
                  <div className="grid grid-cols-[1fr_140px_120px_140px_44px] gap-x-4 items-center px-5 py-4 hover:bg-white/[0.03] transition-colors group">
                    {/* Title */}
                    ...
                    <div>
                      <Link
                        ...
                        className="flex items-center justify-center w-8 h-8 rounded-lg bg-white/[0.05] hover:bg-blue-600 border border-white/[0.08] hover:border-blue-500 text-white/40 hover:text-white transition-all"
